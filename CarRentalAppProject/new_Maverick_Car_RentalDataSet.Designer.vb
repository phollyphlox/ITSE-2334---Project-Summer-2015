...
Namespace new_Maverick_Car_RentalDataSetTableAdapters
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Public Overloads Overridable Function Update(ByVal Organization As String, ByVal First_Name As String, ByVal Middle_Initial As String, ByVal Last_Name As String, ByVal DL__ As Global.System.Nullable(Of Integer), ByVal Credit_Card__ As String, ByVal Street As String, ByVal City As String, ByVal State As String, ByVal Zip_Code As String, ByVal Phone_Number As String, ByVal Age As String, ByVal Original_Key As Integer) As Integer
            If (Organization Is Nothing) Then
    ...
    Partial Public Class PriceTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        Category, Price"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Price"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY Category"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As new_Maverick_Car_RentalDataSet.PriceDataTable) As Integer
